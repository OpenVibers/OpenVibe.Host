'use strict';
// Staff powers come from the openvibe-contracts staff map (ADR-022): staff.site.configure makes a person Host staff (quotas, takedowns, maintaining any project).
