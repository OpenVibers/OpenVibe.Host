 ...
 * Host publishes `host.deploy.activated` to OpenVibe.Events with visibility public and subject
...
const EVENT_TYPE = 'host.deploy.activated';
...
/** The events.event-envelope@1 for a description (payload: contract host.deploy.activated@1). */
