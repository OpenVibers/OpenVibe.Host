 ...
 *   stat(path) -> { mode, uid, gid, owner, isFile, isDir, isSymlink, size, nlink } | null
...
function createSystemExecutor({ env = process.env } = {}) {
    ...
    async function stat(p) {
        try {
            ...
            return { mode: s.mode & 0o7777, uid: s.uid, gid: s.gid, owner: userById(s.uid), isFile: s.isFile(), isDir: s.isDirectory(), isSymlink: l.isSymbolicLink(), size: s.size, nlink: l.nlink };
        } catch { return null; }
    }
