...
Usage: ovhost <command> [args] [--inventory <file>] [--json]
  ...
  announce <service> [--release <id>] [--commit <sha>] [--origin <url>] [--force] [--dry-run]
                                         publish host.deploy.activated to OpenVibe.Events (public), so open
...
const FLAGS_WITH_VALUE = new Set(['inventory', 'to', 'limit', 'warn-days', 'variant', 'manifest', 'out', 'ready-timeout', 'wildcard-cert', 'backup', 'run', 'keep-daily', 'keep-weekly', 'from-host', 'backup-env', 'release', 'commit', 'origin', 'events-env']);
