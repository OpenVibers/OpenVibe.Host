...
function normaliseService(id, raw, defaults) {
    ...
    const out = {
        ...
        // 'git' (a checkout ovhost can move) or 'release' (root-owned releases/<id> behind a
        // `current` symlink, installed by the service's own deploy script: never managed here).
